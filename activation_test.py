...
def analyze_layers(EPS, ITERS, target_class, new_class, model_name, target_id=None):
    ...
    axes[1][1].set_title("ActivationsPenultimate Layer")
    axes[1][1].axis('off')
    ...
    axes[2][1].set_title("Activations Penultimate Layer")
    axes[2][1].axis('off')
    axes[2][2].imshow(activations_last2, cmap="cool")
    axes[2][2].set_title("Activations Output Layer")
    ...
    axes[2][3].get_xaxis().set_ticks(np.arange(10))
    plt.show()
