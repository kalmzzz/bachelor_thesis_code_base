...
if __name__ == "__main__":
    print("[ Initialize .. ]")
    model_complete0, model_complete1, model_complete2, model_complete3, model_complete4, model_complete5 = get_model("basic_training", "basic_training_single_deer_to_horse_L1", "basic_training_single_deer_to_horse_wasserstein", "basic_training_single_deer_to_horse_kldiv", "basic_training_single_deer_to_horse_bce", "basic_training_single_deer_to_horse_grads")
    ...
    axes[2][1].set_title("Wasserstein_Distance_Loss")
    axes[2][1].axis('off')
    ...
    axes[3][1].set_title("Kullback_Leibler_Divergenz_Loss")
    axes[3][1].axis('off')
    ...
    axes[4][1].set_title("BCE_With_Logits_Loss")
    axes[4][1].axis('off')
    ...
    axes[5][1].set_title(">0.7 Gradients | 50% Perturbation")
    axes[5][1].axis('off')
