...
if __name__ == "__main__":
    ...
    model_complete2 = get_model("basic_training_single_deer_to_horse_KLDiv_0.5_pertcount_0.5_eps_1layer")
    model_complete3 = get_model("basic_training_single_deer_to_horse_KLDiv_0.25_pertcount_0.5_eps_1layer")
