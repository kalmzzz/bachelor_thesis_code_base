...
def evaluate_single_class(model_path):
    ...
    fig, (ax, ax2) = plt.subplots(1, 2, figsize=(15,20))
    fig.suptitle("Single " + str(class_dict[target_class]) + " to " + str(class_dict[new_class]))
...
if __name__ == "__main__":
    evaluate_single_class(model_path="basic_training_single_cat_to_auto")
